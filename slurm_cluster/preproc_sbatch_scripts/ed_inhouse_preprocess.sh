...
src_path1=/home/${USER}/ipdis/data/core_data/EdData

# input data directory path on the scratch disk of the node
dest_path=${SCRATCH_HOME}/ipdis/preprep/in_data/EdData
...
rsync --archive --update --compress --progress ${src_path1}/ ${dest_path}

# make directory for preprocessing results
result_path=${SCRATCH_HOME}/ipdis/preprep/out_data/EdData
mkdir -p ${result_path}
...
# commented out so that processes can share data once copied.
# will need to manually delete the data later.
