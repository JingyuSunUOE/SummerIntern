...
# I have copied this from the above author. Once I am happy with my implementation
# I shall get rid of this vesion/
# TOO: DELETE!!!!

# todo implement their reskiunet and densekiunet, 
...
class kiunet(nn.Module):
    ...
    def __init__(self, in_planes, out_planes):
        ...
        self.encoder1 = nn.Conv2d(in_planes, 16, 3, stride=1, padding=1)  # First Layer GrayScale Image , change to input channels to 3 in case of RGB 
        ...
        self.encoderf1 =   nn.Conv2d(in_planes, 16, 3, stride=1, padding=1)  # First Layer GrayScale Image , change to input channels to 3 in case of RGB 
        ...
        self.final = nn.Conv2d(8,out_planes,1,stride=1,padding=0)
...
class reskiunet(nn.Module):
    ...
    def __init__(sel, in_planes, out_planes):
        super(reskiunet, self).__init__()
        

        self.encoder1 = nn.Conv2d(in_planes, 16, 3, stride=1, padding=1) 
...
class densekiunet(nn.Module):
    ...
    def __init__(self, in_planes, out_planes):
        ...
        self.encoder1 = nn.Conv2d(in_planes, out_planes, 16, 3, stride=1, padding=1) 
